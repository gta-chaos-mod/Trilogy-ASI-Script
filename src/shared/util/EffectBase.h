...
enum eEffectGroups : unsigned long long
{
    ...
    GROUP_PEDS_ATTACK        = (1ull << 1),
    GROUP_NPC_RECRUIT        = (1ull << 2),
    GROUP_HEALTH             = (1ull << 3),
    GROUP_THEME              = (1ull << 4),
    GROUP_TIME               = (1ull << 5),
    GROUP_GAME_SPEED         = (1ull << 6),
    GROUP_AUDIO_PITCH        = (1ull << 7),
    GROUP_VEHICLE_COLOR      = (1ull << 8),
    GROUP_VEHICLE_RARITY     = (1ull << 9),
    GROUP_INVISIBLE_VEHICLES = (1ull << 10),
    GROUP_WANTED             = (1ull << 11),
    GROUP_WEAPONS            = (1ull << 12),
    GROUP_CONTROLS           = (1ull << 13),
    GROUP_GRAVITY            = (1ull << 14),
    GROUP_HUD                = (1ull << 15),
    GROUP_CAMERA             = (1ull << 16),
    GROUP_HANDLING           = (1ull << 17),
    GROUP_FRAMERATE          = (1ull << 18),
    GROUP_MIRRORED           = (1ull << 19),
...
public:
    ...
    EffectBase () { EffectDatabase::GetInstance ().RegisterEffect (this); }
};
