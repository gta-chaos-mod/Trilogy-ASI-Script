...
public:
	static void UpdateCooldown(int _remaining, int _cooldown, std::string _mode);
...
public:
	...
	static void Append(RwIm2DVertex* vertices, int index, CVector2D coord, CRGBA color, RwReal u = 0, RwReal v = 0);
