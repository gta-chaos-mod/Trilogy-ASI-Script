...
bool __fastcall DisableAllWeaponDamageEffect::HookedCPedInflictDamage (
    CPed *thisPed, void *edx, CEntity *source, eWeaponType weapon, float damage,
    ePedPieceTypes pedPiece, uchar unknown)
{
    if (weapon <= eWeaponType::WEAPONTYPE_BRASSKNUCKLE
        || weapon == eWeaponType::WEAPONTYPE_ANYMELEE)
    {
...
bool __fastcall DisableAllWeaponDamageEffect::HookedCVehicleInflictDamage (
