...
EffectBase *
DVDScreensaverEffect::SetEffectDuration (int duration)
{
...
void
DVDScreensaverEffect::HandleTick ()
{
...
DVDScreensaverEffect::CalculateStartingXY (int boxNumber)
{
    switch (boxNumber)
    {
    case 0:
...
std::pair<float, float>
DVDScreensaverEffect::CalculateWidthHeight (int boxNumber)
{
    switch (boxNumber)
    {
    case 0:
...
void
DVDScreensaverEffect::DrawScreensaver ()
{
