...
TunnelVisionEffect::TunnelVisionEffect () : EffectBase ("effect_tunnel_vision")
{
    AddType ("hud");
}

EffectBase *
TunnelVisionEffect::SetEffectDuration (int duration)
{
...
void
TunnelVisionEffect::DrawTunnelVision ()
{
