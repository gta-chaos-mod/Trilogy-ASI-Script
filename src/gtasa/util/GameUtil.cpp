...
CPedAcquaintance *
GameUtil::GetSavedAcquaintance (int type)
{
    if (type < 0 || type > 32)
        return nullptr;
...
GameUtil::SetVehiclesToRealPhysics ()
{
    ...
    {
        if (vehicle->m_pDriver && vehicle->CanBeDriven ()
...
float
GameUtil::GetAudioVolumeOrOverride (float volume)
{
