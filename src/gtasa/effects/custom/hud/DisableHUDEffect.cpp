...
void DisableHUDEffect::HookedBlipsDraw() {}

tMenuPanel* DisableHUDEffect::HookedCMenuSystemDisplayGridMenu(unsigned __int8 a1, unsigned __int8 a2) {
	return nullptr;
}

void DisableHUDEffect::HookedCMenuSystemDisplayStandardMenu(unsigned __int8 panelId, bool bBrightFont) {}

void DisableHUDEffect::HookedCHudDrawAreaName() {}
