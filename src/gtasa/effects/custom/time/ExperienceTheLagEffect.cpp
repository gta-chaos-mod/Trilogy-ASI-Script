...
void
ExperienceTheLagEffect::InitializeHooks ()
{
...
int __fastcall ExperienceTheLagEffect::HookedSetFrequencyScalingFactor (
...
int __fastcall ExperienceTheLagEffect::HookedRadioSetVolume (
