...
PitchShifterEffect::PitchShifterEffect () : EffectBase ("effect_pitch_shifter")
{
    AddType ("audio_pitch");
}

void
PitchShifterEffect::InitializeHooks ()
{
...
int __fastcall PitchShifterEffect::HookedSetFrequencyScalingFactor (
...
int __fastcall PitchShifterEffect::HookedRadioSetVolume (
