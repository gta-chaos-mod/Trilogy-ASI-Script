...
namespace
{
    ...
    std::vector<std::function<void (EffectInstance *)>> customCheats = {
        ...
        [] (EffectInstance *inst)
        {
            ...
            auto position
                = player->TransformFromObjectSpace ({ 0.0f, 15.0f, 5.0f });
        ...
        [] (EffectInstance *inst)
        {
            ...
            eWeaponType weapons[]
                = { WEAPONTYPE_CHAINSAW, WEAPONTYPE_KATANA, WEAPONTYPE_SPAS12 };
            for (CPed *ped : CPools::ms_pPedPool)
            {
                ...
                Command<eScriptCommands::COMMAND_GIVE_WEAPON_TO_CHAR> (ped,
                                                                       weapon,
                                                                       1);
