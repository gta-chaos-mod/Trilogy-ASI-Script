...
HonkVehicleEffect::HonkVehicleEffect () : EffectBase ("effect_honk_vehicle") {}

void
HonkVehicleEffect::InitializeHooks ()
{
    HookCall (0x500366, HookedPlayHornOrSiren);
}

void
HonkVehicleEffect::Disable ()
{
...
char __fastcall HonkVehicleEffect::HookedPlayHornOrSiren (
