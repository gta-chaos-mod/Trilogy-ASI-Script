...
void
InvisibleVehiclesEffect::Enable ()
{
    EffectBase::Enable ();
...
void
InvisibleVehiclesEffect::Disable ()
{
...
void
InvisibleVehiclesEffect::HandleTick ()
{
...
void
InvisibleVehiclesEffect::TryRenderAtomic (RwFrame *frameArray[], int size,
                                          int slot)
{
...
void __fastcall InvisibleVehiclesEffect::HookedRenderAutomobile (
...
void __fastcall InvisibleVehiclesEffect::HookedRenderEffects (
    CEntity *thisEntity)
{
    if (!thisEntity)
    {
...
void
InvisibleVehiclesEffect::HookedRenderShadows (CVehicle *   thisVehicle,
                                              VEH_SHD_TYPE shadowType)
{
}

void __fastcall InvisibleVehiclesEffect::HookedCVehicleDoHeadLightBeam (
    CVehicle *thisVehicle, void *edx, int a2, CMatrix *matrix, char a4)
{
}

void __fastcall InvisibleVehiclesEffect::HookedCVehicleAddExhaustParticles (
    CVehicle *thisVehicle)
{
}

void __fastcall InvisibleVehiclesEffect::HookedCVehicleAddWaterSplashParticles (
    CVehicle *thisVehicle)
{
}

void __fastcall InvisibleVehiclesEffect::HookedCVehicleAddSingleWheelParticles (
...
void __fastcall InvisibleVehiclesEffect::
