#include "QuarterGravityEffect.h"

QuarterGravityEffect::QuarterGravityEffect()
	: EffectBase("effect_quarter_gravity")
{
	AddType("gravity");
}

void QuarterGravityEffect::Disable() {
...
void QuarterGravityEffect::HandleTick() {
