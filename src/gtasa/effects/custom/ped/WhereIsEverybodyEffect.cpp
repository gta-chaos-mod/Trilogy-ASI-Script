...
void WhereIsEverybodyEffect::Disable() {
...
void WhereIsEverybodyEffect::HandleTick() {
...
void WhereIsEverybodyEffect::HookedRenderPedShadow(CPed* thisPed, float disp_x, float disp_y, float front_x, float front_y, float side_x, float side_y) {
