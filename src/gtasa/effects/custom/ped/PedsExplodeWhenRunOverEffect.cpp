...
void
PedsExplodeWhenRunOverEffect::InitializeHooks ()
{
...
void __fastcall PedsExplodeWhenRunOverEffect::HookedCPedKillPedWithCar (
    CPed *thisPed, void *edx, CVehicle *car, float arg1, bool arg2)
{
    hasRunOverPed = true;
...
void
PedsExplodeWhenRunOverEffect::HookedCWorldTriggerExplosion (
    CVector *point, float radius, float visibleDistance, CEntity *victim,
    CEntity *creator, bool a7, float damage)
{
    ...
    CWorld::TriggerExplosion (*point, radius, visibleDistance, victim, creator,
                              a7, damage);

    hasRunOverPed = false;
}

bool __fastcall PedsExplodeWhenRunOverEffect::HookedDamageAffectsPed (
    CEventDamage *thisDamage, void *edx, CPed *ped)
{
