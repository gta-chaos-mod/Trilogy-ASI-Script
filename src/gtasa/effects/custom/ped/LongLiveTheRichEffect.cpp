...
bool __fastcall LongLiveTheRichEffect::HookedPickupUpdate(CPickup* thisPickup, void* edx, CPlayerPed* playerPed, CVehicle* vehicle, int playerId) {
	bool isMoneyPickup =
...
void LongLiveTheRichEffect::HookedCHudRenderHealthBar(int playerId, signed int x, signed int y) {}
