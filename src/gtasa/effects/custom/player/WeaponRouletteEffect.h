...
private:
	...
	std::vector<eWeaponType> weapons = {
		// Melee
		eWeaponType::WEAPON_GOLFCLUB,
		eWeaponType::WEAPON_NIGHTSTICK,
		eWeaponType::WEAPON_KNIFE,
		eWeaponType::WEAPON_BASEBALLBAT,
		eWeaponType::WEAPON_SHOVEL,
		eWeaponType::WEAPON_POOLCUE,
		eWeaponType::WEAPON_KATANA,
		eWeaponType::WEAPON_CHAINSAW,

		// Handguns
		eWeaponType::WEAPON_PISTOL,
		eWeaponType::WEAPON_PISTOL_SILENCED,
		eWeaponType::WEAPON_DESERT_EAGLE,

		// Shotguns
		eWeaponType::WEAPON_SHOTGUN,
		eWeaponType::WEAPON_SAWNOFF,
		...
		// Rifles
		eWeaponType::WEAPON_COUNTRYRIFLE,
		eWeaponType::WEAPON_SNIPERRIFLE,

		// Heavy Weapons
		eWeaponType::WEAPON_RLAUNCHER,
		eWeaponType::WEAPON_RLAUNCHER_HS,
		eWeaponType::WEAPON_FTHROWER,
		eWeaponType::WEAPON_MINIGUN,

		// Projectiles
		eWeaponType::WEAPON_GRENADE,
		eWeaponType::WEAPON_TEARGAS,
		eWeaponType::WEAPON_MOLOTOV,
		eWeaponType::WEAPON_SATCHEL_CHARGE,

		// Special
		eWeaponType::WEAPON_SPRAYCAN,
		eWeaponType::WEAPON_EXTINGUISHER
	};
