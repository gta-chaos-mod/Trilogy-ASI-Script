...
QuakeFOVEffect::QuakeFOVEffect()
	: EffectBase("effect_quake_fov") {}

void QuakeFOVEffect::Enable() {
	EffectBase::Enable();
	...
	injector::WriteMemory<float>(0x524BC5, *CDraw_pfScreenFieldOfView + 120.0f, true);
...
void QuakeFOVEffect::HandleTick() {
