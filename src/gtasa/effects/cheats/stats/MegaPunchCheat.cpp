...
void MegaPunchCheat::InitializeHooks() {
...
void __fastcall MegaPunchCheat::HookedFightHitCar(CTaskSimpleFight* thisTask, void* edx, CPed* ped, CVehicle* vehicle, CVector* colCoord, CVector* colDir, int colComp, int a7) {
	...
	CallMethod<0x61D0B0, CTaskSimpleFight*>(thisTask, ped, vehicle, colCoord, colDir, colComp, a7);
}
