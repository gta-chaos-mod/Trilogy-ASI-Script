...
void BeginnerLevelForAllWeaponsCheat::Enable() {
	EffectPlaceholder::Enable();

	CStats::SetStatValue(eStats::STAT_PISTOL_SKILL, 0.0f); // Pistol
	CStats::SetStatValue(eStats::STAT_SILENCED_PISTOL_SKILL, 0.0f); // Silenced pistol
	CStats::SetStatValue(eStats::STAT_DESERT_EAGLE_SKILL, 0.0f); // Desert eagle
	CStats::SetStatValue(eStats::STAT_SHOTGUN_SKILL, 0.0f); // Shotgun
	CStats::SetStatValue(eStats::STAT_SAWN_OFF_SHOTGUN_SKILL, 0.0f); // Sawn-off shotgun
	CStats::SetStatValue(eStats::STAT_COMBAT_SHOTGUN_SKILL, 0.0f); // Combat shotgun
	CStats::SetStatValue(eStats::STAT_MACHINE_PISTOL_SKILL, 0.0f); // Machine pistol
