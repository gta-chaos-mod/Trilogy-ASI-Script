...
void
QuadrupleGameSpeedCheat::InitializeHooks ()
{
...
int __fastcall QuadrupleGameSpeedCheat::HookedSetFrequencyScalingFactor (
...
int __fastcall QuadrupleGameSpeedCheat::HookedRadioSetVolume (
