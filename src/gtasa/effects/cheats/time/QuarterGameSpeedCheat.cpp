...
void
QuarterGameSpeedCheat::InitializeHooks ()
{
...
int __fastcall QuarterGameSpeedCheat::HookedSetFrequencyScalingFactor (
...
int __fastcall QuarterGameSpeedCheat::HookedRadioSetVolume (
