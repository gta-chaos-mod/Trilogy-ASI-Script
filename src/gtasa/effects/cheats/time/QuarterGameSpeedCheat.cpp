...
float QuarterGameSpeedCheat::audioSpeed = 0.6f;
...
void QuarterGameSpeedCheat::Disable() {
...
void QuarterGameSpeedCheat::HandleTick() {
...
int __fastcall QuarterGameSpeedCheat::HookedSetFrequencyScalingFactor(uint8_t* thisAudioHardware, void* edx, int slot, int offset, float factor) {
...
int __fastcall QuarterGameSpeedCheat::HookedRadioSetVolume(uint8_t* thisAudioHardware, void* edx, int a2, int a3, float volume, int a5) {
