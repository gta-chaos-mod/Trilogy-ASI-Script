...
void DoubleGameSpeedCheat::InitializeHooks() {
...
int __fastcall DoubleGameSpeedCheat::HookedSetFrequencyScalingFactor(uint8_t* thisAudioHardware, void* edx, int slot, int offset, float factor) {
...
int __fastcall DoubleGameSpeedCheat::HookedRadioSetVolume(uint8_t* thisAudioHardware, void* edx, int a2, int a3, float volume, int a5) {
