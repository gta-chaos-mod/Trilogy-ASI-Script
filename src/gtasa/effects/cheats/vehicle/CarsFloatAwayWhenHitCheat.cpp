...
void CarsFloatAwayWhenHitCheat::Enable() {
	EffectBase::Enable();

	applyCollisionEvent += ApplyCollision;
}

void CarsFloatAwayWhenHitCheat::Disable() {
	applyCollisionEvent -= ApplyCollision;
...
void CarsFloatAwayWhenHitCheat::ApplyCollision(CVehicle* thisVehicle, CVehicle* a2, int a3, float* a4, int a5) {
	CVehicle* playerVehicle = FindPlayerVehicle(-1, false);
