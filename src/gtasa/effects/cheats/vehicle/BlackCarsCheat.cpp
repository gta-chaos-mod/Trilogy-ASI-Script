...
BlackCarsCheat::BlackCarsCheat()
	: EffectBase("cheat_black_cars")
{
	AddType("vehicle_color");
}

void BlackCarsCheat::Enable() {
	EffectBase::Enable();
...
void BlackCarsCheat::SetupRenderEvent(CVehicle* vehicle) {
	ModifyCarPaint(vehicle);
}

void BlackCarsCheat::ResetAfterRenderEvent(CVehicle* vehicle) {
...
void BlackCarsCheat::ModifyCarPaint(CVehicle* vehicle) {
...
RpMaterial* BlackCarsCheat::MaterialCallback(RpMaterial* material, void* data) {
	if (!data) {
		return material;
	}
...
RpAtomic* BlackCarsCheat::AtomicCallback(RpAtomic* atomic, void* data) {
	if (atomic->geometry) {
