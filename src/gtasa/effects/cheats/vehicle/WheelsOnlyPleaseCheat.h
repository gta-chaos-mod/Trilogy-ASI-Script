...
class WheelsOnlyPleaseCheat : public EffectBase
{
private:
    bool oldForceVehicleLightsOff = false;

public:
    WheelsOnlyPleaseCheat ();
    ...
    static uint8_t *HookedRwIm3DTransform (uint8_t *pVerts, signed int numVerts,
                                           RwMatrix *ltm, unsigned int flags);
    static void __fastcall HookedRenderEffects (CEntity *thisEntity);
    static void HookedRenderShadows (CVehicle *   thisVehicle,
                                     VEH_SHD_TYPE shadowType);

    static void __fastcall HookedCVehicleDoHeadLightBeam (CVehicle *thisVehicle,
                                                          void *edx, int a2,
                                                          CMatrix *matrix,
                                                          char     a4);
    static void __fastcall HookedCVehicleAddExhaustParticles (
        CVehicle *thisVehicle);
    static void __fastcall HookedCVehicleAddWaterSplashParticles (
        CVehicle *thisVehicle);
    static void __fastcall HookedCVehicleAddSingleWheelParticles (
    ...
    static void __fastcall HookedCVehicleAddDamagedVehicleParticles (
        CVehicle *thisVehicle);
};
