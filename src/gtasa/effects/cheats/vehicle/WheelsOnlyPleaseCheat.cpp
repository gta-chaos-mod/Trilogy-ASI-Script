...
void
WheelsOnlyPleaseCheat::InitializeHooks ()
{
...
void
WheelsOnlyPleaseCheat::HandleTick ()
{
...
void
WheelsOnlyPleaseCheat::TryRenderAtomic (RwFrame *frameArray[], int size,
                                        int slot)
{
...
void __fastcall WheelsOnlyPleaseCheat::HookedRenderAutomobile (
    CAutomobile *thisAutomobile)
{
    ...
    TryRenderAtomic (thisAutomobile->m_aCarNodes, eCarNodes::CAR_NUM_NODES,
                     eCarNodes::CAR_WHEEL_RF);
    TryRenderAtomic (thisAutomobile->m_aCarNodes, eCarNodes::CAR_NUM_NODES,
                     eCarNodes::CAR_WHEEL_RM);
    TryRenderAtomic (thisAutomobile->m_aCarNodes, eCarNodes::CAR_NUM_NODES,
                     eCarNodes::CAR_WHEEL_RB);

    TryRenderAtomic (thisAutomobile->m_aCarNodes, eCarNodes::CAR_NUM_NODES,
                     eCarNodes::CAR_WHEEL_LF);
    TryRenderAtomic (thisAutomobile->m_aCarNodes, eCarNodes::CAR_NUM_NODES,
                     eCarNodes::CAR_WHEEL_LM);
    TryRenderAtomic (thisAutomobile->m_aCarNodes, eCarNodes::CAR_NUM_NODES,
                     eCarNodes::CAR_WHEEL_LB);
}
...
void __fastcall WheelsOnlyPleaseCheat::HookedRenderHeli (CHeli *thisHeli)
{
    ...
    TryRenderAtomic (thisHeli->m_aCarNodes, eHeliNodes::HELI_NUM_NODES,
                     eHeliNodes::HELI_WHEEL_RF);
    TryRenderAtomic (thisHeli->m_aCarNodes, eHeliNodes::HELI_NUM_NODES,
                     eHeliNodes::HELI_WHEEL_RM);
    TryRenderAtomic (thisHeli->m_aCarNodes, eHeliNodes::HELI_NUM_NODES,
                     eHeliNodes::HELI_WHEEL_RB);

    TryRenderAtomic (thisHeli->m_aCarNodes, eHeliNodes::HELI_NUM_NODES,
                     eHeliNodes::HELI_WHEEL_LF);
    TryRenderAtomic (thisHeli->m_aCarNodes, eHeliNodes::HELI_NUM_NODES,
                     eHeliNodes::HELI_WHEEL_LM);
    TryRenderAtomic (thisHeli->m_aCarNodes, eHeliNodes::HELI_NUM_NODES,
                     eHeliNodes::HELI_WHEEL_LB);
}
...
void __fastcall WheelsOnlyPleaseCheat::HookedRenderBike (CBike *thisBike)
{
    ...
    TryRenderAtomic (thisBike->m_aBikeNodes, eBikeNodes::BIKE_NUM_NODES,
                     eBikeNodes::BIKE_WHEEL_FRONT);
    TryRenderAtomic (thisBike->m_aBikeNodes, eBikeNodes::BIKE_NUM_NODES,
                     eBikeNodes::BIKE_WHEEL_REAR);
}
...
void __fastcall WheelsOnlyPleaseCheat::HookedRenderPlane (CPlane *thisPlane)
{
    ...
    TryRenderAtomic (thisPlane->m_aCarNodes, ePlaneNodes::PLANE_NUM_NODES,
                     ePlaneNodes::PLANE_WHEEL_RF);
    TryRenderAtomic (thisPlane->m_aCarNodes, ePlaneNodes::PLANE_NUM_NODES,
                     ePlaneNodes::PLANE_WHEEL_RM);
    TryRenderAtomic (thisPlane->m_aCarNodes, ePlaneNodes::PLANE_NUM_NODES,
                     ePlaneNodes::PLANE_WHEEL_RB);

    TryRenderAtomic (thisPlane->m_aCarNodes, ePlaneNodes::PLANE_NUM_NODES,
                     ePlaneNodes::PLANE_WHEEL_LF);
    TryRenderAtomic (thisPlane->m_aCarNodes, ePlaneNodes::PLANE_NUM_NODES,
                     ePlaneNodes::PLANE_WHEEL_LM);
    TryRenderAtomic (thisPlane->m_aCarNodes, ePlaneNodes::PLANE_NUM_NODES,
                     ePlaneNodes::PLANE_WHEEL_LB);
}
...
void __fastcall WheelsOnlyPleaseCheat::HookedRenderTrain (CTrain *thisTrain)
{
    ...
    TryRenderAtomic (thisTrain->m_aTrainNodes, eTrainNodes::TRAIN_NUM_NODES,
                     eTrainNodes::TRAIN_WHEEL_LB1);
    TryRenderAtomic (thisTrain->m_aTrainNodes, eTrainNodes::TRAIN_NUM_NODES,
                     eTrainNodes::TRAIN_WHEEL_LB2);
    TryRenderAtomic (thisTrain->m_aTrainNodes, eTrainNodes::TRAIN_NUM_NODES,
                     eTrainNodes::TRAIN_WHEEL_LB3);

    TryRenderAtomic (thisTrain->m_aTrainNodes, eTrainNodes::TRAIN_NUM_NODES,
                     eTrainNodes::TRAIN_WHEEL_LF1);
    TryRenderAtomic (thisTrain->m_aTrainNodes, eTrainNodes::TRAIN_NUM_NODES,
                     eTrainNodes::TRAIN_WHEEL_LF2);
    TryRenderAtomic (thisTrain->m_aTrainNodes, eTrainNodes::TRAIN_NUM_NODES,
                     eTrainNodes::TRAIN_WHEEL_LF3);

    TryRenderAtomic (thisTrain->m_aTrainNodes, eTrainNodes::TRAIN_NUM_NODES,
                     eTrainNodes::TRAIN_WHEEL_RB1);
    TryRenderAtomic (thisTrain->m_aTrainNodes, eTrainNodes::TRAIN_NUM_NODES,
                     eTrainNodes::TRAIN_WHEEL_RB2);
    TryRenderAtomic (thisTrain->m_aTrainNodes, eTrainNodes::TRAIN_NUM_NODES,
                     eTrainNodes::TRAIN_WHEEL_RB3);

    TryRenderAtomic (thisTrain->m_aTrainNodes, eTrainNodes::TRAIN_NUM_NODES,
                     eTrainNodes::TRAIN_WHEEL_RF1);
    TryRenderAtomic (thisTrain->m_aTrainNodes, eTrainNodes::TRAIN_NUM_NODES,
                     eTrainNodes::TRAIN_WHEEL_RF2);
    TryRenderAtomic (thisTrain->m_aTrainNodes, eTrainNodes::TRAIN_NUM_NODES,
                     eTrainNodes::TRAIN_WHEEL_RF3);
}

void __fastcall WheelsOnlyPleaseCheat::HookedRenderBoat (CBoat *thisBoat) {}

uint8_t *
WheelsOnlyPleaseCheat::HookedRwIm3DTransform (uint8_t *  pVerts,
                                              signed int numVerts,
                                              RwMatrix *ltm, unsigned int flags)
{
    return nullptr;
}
...
void
WheelsOnlyPleaseCheat::HookedRenderShadows (CVehicle *   thisVehicle,
                                            VEH_SHD_TYPE shadowType)
{
}

void __fastcall WheelsOnlyPleaseCheat::HookedCVehicleDoHeadLightBeam (
    CVehicle *thisVehicle, void *edx, int a2, CMatrix *matrix, char a4)
{
}

void __fastcall WheelsOnlyPleaseCheat::HookedCVehicleAddExhaustParticles (
    CVehicle *thisVehicle)
{
}

void __fastcall WheelsOnlyPleaseCheat::HookedCVehicleAddWaterSplashParticles (
    CVehicle *thisVehicle)
{
}

void __fastcall WheelsOnlyPleaseCheat::HookedCVehicleAddSingleWheelParticles (
...
void __fastcall WheelsOnlyPleaseCheat::
    HookedCVehicleAddDamagedVehicleParticles (CVehicle *thisVehicle)
{
}
