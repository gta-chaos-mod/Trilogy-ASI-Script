...
void
InfiniteHealthCheat::InitializeHooks ()
{
...
void
InfiniteHealthCheat::HandleTick ()
{
...
void __fastcall InfiniteHealthCheat::HookedComputeWillKillPed (
...
void __fastcall InfiniteHealthCheat::HookedKillPedsInVehicle (
